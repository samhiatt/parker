...
describe('schedule', function() {
  ...
  describe('check events', function () {
    ...
    describe('test date input formats',function(){
      ...
      describe("next('2015-01-01')", function () {
        var nextEvent = schedule.next('2015-01-01');
        checkEvent(nextEvent, moment('2015-01-01'));
        it('should be year 2015',function() {
          assert.equal(nextEvent.start.year(), 2015);
        });
      });
      describe("next('2015-12-31 12:00')", function () {
        var nextEvent = schedule.next('2015-12-31 12:00');
      ...
      describe("next(new Date('2015-12-31Z'))", function () {
        var date = new Date('2015-01-01Z');
        var nextEvent = schedule.next(date);
